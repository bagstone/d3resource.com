...
<head>
	<meta charset="utf-8"/>
	<title>Diablo 3: Season 8 Journey Tracker</title>
...
<h1>Diablo 3: Season 8 Journey Tracker</h1>
...
<p>List of conquests in Season 8 (click <a href="http://d3resource.com/journey/s8-conquests.jpg" target="_blank">here for screenshots</a> with full wording):</p>
...
<table class="sjtablelayout">
	...
	<tr class="sjtable">
		...
		<td id="td-sj5c" class="cat5 sjtable sjitem kill">Cydaea<br />(T7, level 70)</td>
		<td id="td-sj6c" class="cat6 sjtable sjitem kill">Diablo (T10)</td>
		<td id="td-sj7c" class="cat7 sjtable sjitem kill">Rakanoth (T13)</td>
		<td id="td-sj8c" class="cat8 sjtable sjitem kill">Greed (Vault)<br />(T13)</td>
		<td id="td-sj9c" class="cat9 sjtable sjitem kill">Belial (T13) in<br />under 45 seconds</td>
	</tr>
	<tr class="sjtable">
		...
		<td id="td-sj5d" class="cat5 sjtable sjitem kill">Malthael<br />(T7, level 70)</td>
		<td id="td-sj6d" class="cat6 sjtable sjitem kill">Ghom (T11)</td>
		<td id="td-sj7d" class="cat7 sjtable sjitem kill">Araneae (T13)</td>
		<td id="td-sj8d" class="cat8 sjtable sjitem kill">Izual (T13)</td>
	...
	<tr class="sjtable">
		...
		<td id="td-sj3k" class="cat3 sjtable rewards">2<sup>nd</sup> Haedrig<br />(feet+shoulders;<br />barb: feet+belt<br />DH: feet+ring)</td>
		<td id="td-sj4k" class="cat4 sjtable rewards">3<sup>rd</sup> Haedrig,<br />portrait frame,<br />Andariel's Wings</td>
...
<span class="red">NOTE - information on S8 updates was kindly provided by <a href="https://www.reddit.com/r/Diablo/comments/57571c/first_look_season_8_journey/d8pfp31" target="_blank">Tyvalir</a>, but typos/errors are always possible.<br />If you find any, please report them on DFans <a href="http://www.diablofans.com/forums/diablo-iii-general-forums/diablo-iii-general-discussion/211245-season-journey-tracker" target="_blank">in this thread</a>.</span>
-->

<div id="bottomdiv">
	Haedrig's Gift contains the following class sets in Season 8:
	<br />
	Barbarian: <a href="http://us.battle.net/d3/en/item/immortal-kings-triumph" target="_blank">Immortal King's Call</a> - 
	Crusader: <a href="http://us.battle.net/d3/en/item/crown-of-the-light" target="_blank">Seeker of the Light</a> - 
	Demon Hunter: <a href="http://us.battle.net/d3/en/item/natalyas-sight" target="_blank">Natalya's Vengeance</a>
	<br />
	Monk: <a href="http://us.battle.net/d3/en/item/ulianas-spirit" target="_blank">Uliana's Stratagem</a> - 
	Witch Doctor: <a href="http://us.battle.net/d3/en/item/arachyrs-visage" target="_blank">Spirit of Arachyr</a> - 
	Wizard: <a href="http://us.battle.net/d3/en/item/vyrs-sightless-skull" target="_blank">Vyr's Amazing Arcana</a>
	<br /><br /><br />
...
$('td.conqitem').click(function(event) {
	...
	// if gr55 check solo grs + rift
	if(conqid === 'conq-d' || conqid === 'conq-i') {
		if($('#conq-d').hasClass('done') || $('#conq-i').hasClass('done')) {
			setSJ('4', 'b'); setSJ('5', 'b'); setSJ('6', 'b'); setSJ('7', 'b'); setSJ('1', 'a');
		}
	}
	
	// set dungeon conquest checks set dungeon completed + mastery
