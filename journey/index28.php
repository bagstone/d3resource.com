...
<head>
	<meta charset="utf-8"/>
	<title>Diablo 3: Season 28 Journey Tracker</title>
...
<h1>Diablo 3: Season 28 Journey Tracker</h1>

<!--
Season start countdown: <br /><br />
...
<p>List of conquests in Season 16:</p>
...
<table class="sjtablelayout">
	...
	<tr class="sjtable">
		<td id="td-sj1c" class="cat1 sjtable sjitem kill">Ghom</td>
		<td id="td-sj2c" class="cat2 sjtable sjitem kill">Urzael<br />(Hard, level 60+)</td>
		<td id="td-sj3c" class="cat3 sjtable sjitem kill">Zoltun Kulle<br />(Master, level 70+)</td>
		<td id="td-sj4c" class="cat4 sjtable sjitem kill">Skeleton King<br />(T2, level 70)</td>
		...
		<td id="td-sj7c" class="cat7 sjtable sjitem kill">Adria<br />(T13)</td>
		<td id="td-sj8c" class="cat8 sjtable sjitem kill">Azmodan<br />in under 30 sec.</td>
		<td id="td-sj9c" class="cat9 sjtable sjitem kill">Izual<br />in under 10 sec.</td>
	</tr>
	<tr class="sjtable">
		<td id="td-sj1d" class="cat1 sjtable sjitem kill">Belial</td>
		<td id="td-sj2d" class="cat2 sjtable sjitem kill">Araneae<br />(Hard, level 60+)</td>
		<td id="td-sj3d" class="cat3 sjtable sjitem kill">Rakanoth<br />(Master, level 70+)</td>
		<td id="td-sj4d" class="cat4 sjtable sjitem kill">Cydaea<br />(T4, level 70)</td>
		<td id="td-sj5d" class="cat5 sjtable sjitem kill">Maghda<br />(T7)</td>
		<td id="td-sj6d" class="cat6 sjtable sjitem kill">Siegebreaker<br />(T10)</td>
...
var countDownDateNA = new Date("Feb 25, 2023 1:00:00 UTC").getTime();
var countDownDateEU = new Date("Feb 24, 2023 16:00:00 UTC").getTime();
var countDownDateAsia = new Date("Feb 24, 2023 8:00:00 UTC").getTime();
