...
<head>
	<meta charset="utf-8"/>
	<title>Diablo 3: Season 25 Journey Tracker</title>
...
<h1>Diablo 3: Season 25 Journey Tracker</h1>
...
<p>List of conquests in Season 25:</p>
...
<table class="sjtablelayout">
	...
	<tr class="sjtable">
		...
		<td id="td-sj8c" class="cat8 sjtable sjitem kill">Cydaea (T13)<br />in under 30 sec.</td>
...
var countDownDateNA = new Date("Dec 11, 2021 0:00:00 UTC").getTime();
var countDownDateEU = new Date("Dec 10, 2021 15:00:00 UTC").getTime();
var countDownDateAsia = new Date("Dec 10, 2021 10:00:00 UTC").getTime();
