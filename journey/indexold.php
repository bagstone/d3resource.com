...
<head>
	<meta charset="utf-8"/>
	<title>Diablo 3: Season 20 Journey Tracker</title>
...
<h1>Diablo 3: Season 33 Journey Tracker</h1>

<div id="countdowndiv">
	<div class="countdowndiv">NA/Console ends:
		<p class="countdown" id="countdown_na"></p>
	</div>

	<div class="countdowndiv">EU ends:
		<p class="countdown" id="countdown_eu"></p>
	</div>

	<div class="countdowndiv">Asia ends:
...
<p>List of conquests in Season 33:</p>
...
<tr class="sjtable">
        <td id="td-sj1c" class="cat1 sjtable sjitem kill done">Urzael</td>
        <td id="td-sj2c" class="cat2 sjtable sjitem kill done">Maghda<br>(Hard, level 60+)</td>
        <td id="td-sj3c" class="cat3 sjtable sjitem kill done">Queen Araneae<br>(Master, level 70+)</td>
        <td id="td-sj4c" class="cat4 sjtable sjitem kill done">Ghom<br>(T2, level 70)</td>
        <td id="td-sj5c" class="cat5 sjtable sjitem kill done">Diablo<br>(T7)</td>
        <td id="td-sj6c" class="cat6 sjtable sjitem kill done">Rakanoth<br>(T10)</td>
        <td id="td-sj7c" class="cat7 sjtable sjitem kill done">Cydea<br>(T13)</td>
        <td id="td-sj8c" class="cat8 sjtable sjitem kill done">Skeleton King (T13)<br>in under 30 sec.</td>
        <td id="td-sj9c" class="cat9 sjtable sjitem kill done">Butcher (T13)<br>in under 15 sec.</td>
    </tr>
    <tr class="sjtable">
        <td id="td-sj1d" class="cat1 sjtable sjitem kill done">Belial</td>
        <td id="td-sj2d" class="cat2 sjtable sjitem kill done">Zoltun Kulle<br>(Hard, level 60+)</td>
        <td id="td-sj3d" class="cat3 sjtable sjitem kill done">Siegebreaker<br>(Master, level 70+)</td>
        <td id="td-sj4d" class="cat4 sjtable sjitem kill done">Malthael<br>(T4, level 70)</td>
        <td id="td-sj5d" class="cat5 sjtable sjitem kill done">Izual<br>(T7)</td>
        <td id="td-sj6d" class="cat6 sjtable sjitem kill done">Adria<br>(T10)</td>
        <td id="td-sj7d" class="cat7 sjtable sjitem kill done">Azmodan<br>(T13)</td>
        <td id="td-sj8d" class="cat8 sjtable sjitem kill done">Greed (T13)</td>
...
var countDownDateNA = new Date("Jan 20, 2025 1:00:00 UTC").getTime();
//var countDownDateNA = new Date(1720828800*1000).getTime();
var countDownDateEU = new Date("Jan 19, 2025 16:00:00 UTC").getTime();
//var countDownDateEU = new Date(1720796400*1000).getTime();
var countDownDateAsia = new Date("Jan 19, 2025 8:00:00 UTC").getTime();
//var countDownDateAsia = new Date(1720771200*1000).getTime();
