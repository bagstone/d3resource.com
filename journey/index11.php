...
<head>
	<meta charset="utf-8"/>
	<title>Diablo 3: Season 11 Journey Tracker</title>
...
<h1>Diablo 3: Season 11 Journey Tracker</h1>
...
<p>List of conquests in Season 11:</p>
...
<table class="sjtablelayout">
	...
	<tr class="sjtable">
		...
		<td id="td-sj3c" class="cat3 sjtable sjitem kill">Diablo<br />(Master, level 70+)</td>
		<td id="td-sj4c" class="cat4 sjtable sjitem kill">Rakanoth<br />(T2, level 70)</td>
		<td id="td-sj5c" class="cat5 sjtable sjitem kill">Butcher (T7)</td>
		<td id="td-sj6c" class="cat6 sjtable sjitem kill">Belial<br />(T10)</td>
		<td id="td-sj7c" class="cat7 sjtable sjitem kill">Skeleton King<br />(T13)</td>
		<td id="td-sj8c" class="cat8 sjtable sjitem kill">Siegebr. (T13)<br />in under 30 sec.</td>
	...
	<tr class="sjtable">
		...
		<td id="td-sj3d" class="cat3 sjtable sjitem kill">Cydaea<br />(Master, level 70+)</td>
		<td id="td-sj4d" class="cat4 sjtable sjitem kill">Maghda<br />(T4, level 70)</td>
		<td id="td-sj5d" class="cat5 sjtable sjitem kill">Izual (T7)</td>
		<td id="td-sj6d" class="cat6 sjtable sjitem kill">Araneae<br />(T10)</td>
		<td id="td-sj7d" class="cat7 sjtable sjitem kill">Azmodan<br />(T13)</td>
	...
	<tr class="sjtable">
		...
		<td id="td-sj3m" class="cat3 sjtable rewards">2<sup>nd</sup> Haedrig<br />(feet+shoulders;<br />wiz: belt+neck)</td>
		<td id="td-sj4m" class="cat4 sjtable rewards">3<sup>rd</sup> Haedrig,<br />portrait frame,<br />dragon pet</td>
...
<div id="bottomdiv">
	...
	<br />
	Barbarian: <a href="https://us.battle.net/d3/en/item/helm-of-the-wastes" target="_blank">Wrath of the Wastes</a> - 
	Crusader: <a href="https://us.battle.net/d3/en/item/rolands-visage" target="_blank">Roland's Legacy</a> - 
	Demon Hunter: <a href="https://us.battle.net/d3/en/item/accursed-visage" target="_blank">Unhallowed Essence</a>
	<br />
	Monk: <a href="https://us.battle.net/d3/en/item/mask-of-the-searing-sky" target="_blank">Raiment of a Thousand Storms</a> - 
	Witch Doctor: <a href="https://us.battle.net/d3/en/item/helltooth-mask" target="_blank">Helltooth Harness</a> - 
	Wizard: <a href="https://us.battle.net/d3/en/item/tal-rashas-guise-of-wisdom" target="_blank">Tal Rasha's Elements</a>
	<br />
	New class, the Necromancer: <a href="https://us.battle.net/d3/en/item/rathmas-skull-helm" target="_blank">Bones of Rathma</a>
	<br /><br /><br />
...
var x = setInterval(function() {
	...
	if (distanceNA < 0) {
		document.getElementById("countdown_na").innerHTML = "S11 ended";
	} else {
	...
	if (distanceEU < 0) {
		document.getElementById("countdown_eu").innerHTML = "S11 ended";
	} else {
	...
	if (distanceAsia < 0) {
		document.getElementById("countdown_asia").innerHTML = "S11 ended";
	} else {
