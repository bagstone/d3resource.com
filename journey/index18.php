...
<head>
	<meta charset="utf-8"/>
	<title>Diablo 3: Season 18 Journey Tracker</title>
...
<h1>Diablo 3: Season 18 Journey Tracker</h1>
...
<p>List of conquests in Season 18:</p>
...
<table class="sjtablelayout">
	...
	<tr class="sjtable">
		<td id="td-sj1c" class="cat1 sjtable sjitem kill">Araneae</td>
		<td id="td-sj2c" class="cat2 sjtable sjitem kill">Maghda<br />(Hard, level 60+)</td>
		<td id="td-sj3c" class="cat3 sjtable sjitem kill">Butcher<br />(Master, level 70+)</td>
		<td id="td-sj4c" class="cat4 sjtable sjitem kill">Izual<br />(T2, level 70)</td>
		<td id="td-sj5c" class="cat5 sjtable sjitem kill">Skeleton King<br />(T7)</td>
		<td id="td-sj6c" class="cat6 sjtable sjitem kill">Ghom<br />(T10)</td>
		<td id="td-sj7c" class="cat7 sjtable sjitem kill">Malthael<br />(T13)</td>
		<td id="td-sj8c" class="cat8 sjtable sjitem kill">Rakanoth (T13)<br />in under 15 sec.</td>
		<td id="td-sj9c" class="cat9 sjtable sjitem kill">Diablo (T13)<br />in under 60 sec.</td>
	</tr>
	<tr class="sjtable">
		<td id="td-sj1d" class="cat1 sjtable sjitem kill">Cydaea</td>
		<td id="td-sj2d" class="cat2 sjtable sjitem kill">Adria<br />(Hard, level 60+)</td>
		<td id="td-sj3d" class="cat3 sjtable sjitem kill">Urzael<br />(Master, level 70+)</td>
		<td id="td-sj4d" class="cat4 sjtable sjitem kill">Kulle<br />(T4, level 70)</td>
		<td id="td-sj5d" class="cat5 sjtable sjitem kill">Belial<br />(T7)</td>
		<td id="td-sj6d" class="cat6 sjtable sjitem kill">Azmodan<br />(T10)</td>
		<td id="td-sj7d" class="cat7 sjtable sjitem kill">Siegebreaker<br />(T10)</td>
...
$('span.categories').click(function(event) {
	...
	$('td.sjitem.'+event.target.id.toString()).toggleClass('selected');
	if(event.target.id.toString()=='conquests') {
		$('div#conqdiv').toggleClass('hidden');
		$('td.conqitem').toggleClass('selected');
	} else {
		$('td.sjitem:not(.'+event.target.id.toString()+')').toggleClass('greyedout');
	}
});

// countdown from https://www.w3schools.com/howto/howto_js_countdown.asp
// Set the date we're counting down to
var countDownDateNA = new Date("Nov 11, 2019 1:00:00 UTC").getTime();
var countDownDateEU = new Date("Nov 10, 2019 16:00:00 UTC").getTime();
var countDownDateAsia = new Date("Nov 10, 2019 8:00:00 UTC").getTime();
