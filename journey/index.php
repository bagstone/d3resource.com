...
$sharedProgress = isset($sharedProgress) && is_array($sharedProgress) ? $sharedProgress : null;
$sharedProgressJson = json_encode($sharedProgress, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT);
?>
<!DOCTYPE html><html lang="en"><head>
<meta charset="utf-8"/><title>Diablo 3: Season <?= (int)$season['number'] ?> Journey Tracker</title>
<script src="/_script/jquery-3.0.0.min.js"></script><script src="/journey/jquery-ui-1.12.1/jquery-ui.min.js"></script><script src="/journey/functions.js"></script><script src="/journey/journey.js" defer></script>
<link rel="stylesheet" href="/journey/main-style.css"/><link rel="stylesheet" href="/_style/d3rheader.css"/><link rel="stylesheet" href="/journey/jquery-ui-1.12.1/jquery-ui.min.css"/>
</head><body>
...
<div id="bottomdiv">Haedrig's Gift contains the following class sets this season:<br><?php renderHaedrigSets($season['haedrigSets']); ?><br><br><br><span class="button bigger" id="resetall">Reset all</span>&nbsp;&nbsp;&nbsp;<span class="button bigger" id="shareprogress">Share progress</span><br><br><br><?php include __DIR__ . '/../footer.php'?></div></div>
...
<script>window.journeySeason = <?= $json ?>; window.journeySharedProgress = <?= $sharedProgressJson ?>;</script></body></html>
