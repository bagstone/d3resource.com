...
var countDownDateNA = new Date("Oct 26, 2024 0:00:00 UTC").getTime();
//var countDownDateNA = new Date(1720828800*1000).getTime();
var countDownDateEU = new Date("Oct 25, 2024 15:00:00 UTC").getTime();
//var countDownDateEU = new Date(1720796400*1000).getTime();
var countDownDateAsia = new Date("Oct 25, 2024 8:00:00 UTC").getTime();
