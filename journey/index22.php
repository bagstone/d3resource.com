...
<head>
	<meta charset="utf-8"/>
	<title>Diablo 3: Season 22 Journey Tracker</title>
...
<h1>Diablo 3: Season 22 Journey Tracker</h1>
...
<span class="subtitle">Check out <a href="https://maxroll.gg/resources/season-start-1-70-leveling-guide" target="_blank">Maxroll.gg for an in-depth 1-70 leveling guide</a> and other season start tips!</span>
-->
...
<p>List of conquests in Season 22:</p>
<table class="conqtablelayout">
	<tr>
		...
		<td id="conq-a" class="conqitem">
			...
			<span class="conqdesc">Act I-V in 1 hour</span>
		</td>
...
<table class="sjtablelayout">
	...
	<tr class="sjtable">
		<td id="td-sj1c" class="cat1 sjtable sjitem kill">Cydaea</td>
		<td id="td-sj2c" class="cat2 sjtable sjitem kill">Araneae<br />(Hard, level 60+)</td>
		<td id="td-sj3c" class="cat3 sjtable sjitem kill">Malthael<br />(Master, level 70+)</td>
		<td id="td-sj4c" class="cat4 sjtable sjitem kill">Diablo<br />(T2, level 70)</td>
		<td id="td-sj5c" class="cat5 sjtable sjitem kill">Siegebreaker<br />(T7)</td>
		<td id="td-sj6c" class="cat6 sjtable sjitem kill">Butcher<br />(T10)</td>
		<td id="td-sj7c" class="cat7 sjtable sjitem kill">Urzael<br />(T13)</td>
		<td id="td-sj8c" class="cat8 sjtable sjitem kill">Magda (T13)<br />in under 15 sec.</td>
		<td id="td-sj9c" class="cat9 sjtable sjitem kill">Adria (T13)<br />in under 15 sec.</td>
	</tr>
	<tr class="sjtable">
		<td id="td-sj1d" class="cat1 sjtable sjitem kill">Skeleton King</td>
		<td id="td-sj2d" class="cat2 sjtable sjitem kill">Ghom<br />(Hard, level 60+)</td>
		<td id="td-sj3d" class="cat3 sjtable sjitem kill">Izual<br />(Master, level 70+)</td>
		<td id="td-sj4d" class="cat4 sjtable sjitem kill">Belial<br />(T4, level 70)</td>
		<td id="td-sj5d" class="cat5 sjtable sjitem kill">Azmodan<br />(T7)</td>
		<td id="td-sj6d" class="cat6 sjtable sjitem kill">Kulle<br />(T10)</td>
...
<div id="bottomdiv">
	...
	<br />
	Barbarian: <a href="https://eu.diablo3.com/en-gb/item/skull-of-savages-P68_Unique_Helm_Set_05" target="_blank">Horde of the Ninety Savages</a> - 
	Crusader: <a href="https://eu.diablo3.com/en-gb/item/crown-of-valor-P67_Unique_Helm_Set_01" target="_blank">Aegis of Valor</a> - 
	Demon Hunter: <a href="https://eu.diablo3.com/en-gb/item/dystopian-goggles-P69_Unique_Helm_Set_06" target="_blank">Gears of Dreadlands</a>
	<br />
	Monk: <a href="https://eu.diablo3.com/en-gb/item/decree-of-justice-P67_Unique_Helm_Set_02" target="_blank">Patterns of Justice</a> - 
	Witch Doctor: <a href="https://eu.diablo3.com/en-gb/item/mundunugus-headdress-P68_Unique_Helm_Set_04" target="_blank">Mundunugu's Regalia</a> - 
	Wizard: <a href="https://eu.diablo3.com/en-gb/item/typhons-frons-P68_Unique_Helm_Set_03" target="_blank">The Typhon's Veil</a>
	<br />
	Necromancer: <a href="https://eu.diablo3.com/en-gb/item/luxurious-bauta-P69_Necro_Set_5_Helm" target="_blank">Masquerade of the Burning Carnival</a>
	<br /><br /><br />
...
/*	if(conqid != 'conq-d' && conqid != 'conq-i') {
		...
		if(conqid != 'conq-d' && conqid != 'conq-i' && conqid != 'conq-a' && conqid != 'conq-f') {
			setSJ('1', 'a');
		}
	}*/
...
var countDownDateNA = new Date("Nov 21, 2020 1:00:00 UTC").getTime();
var countDownDateEU = new Date("Nov 20, 2020 16:00:00 UTC").getTime();
var countDownDateAsia = new Date("Nov 20, 2020 8:00:00 UTC").getTime();
