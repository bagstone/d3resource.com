...
<head>
	<meta charset="utf-8"/>
	<title>Diablo 3: Season 29 Journey Tracker</title>
...
<h1>Diablo 3: Season 29 Journey Tracker</h1>

<!--
<div id="countdowndiv">
	<div class="countdowndiv">Countdown Start NA:
		<p class="countdown" id="countdown_na"></p>
	</div>

	<div class="countdowndiv">Countdown Start EU:
		<p class="countdown" id="countdown_eu"></p>
	</div>

	<div class="countdowndiv">Countdown Start Asia:
...
<p>List of conquests in Season 29:</p>
...
<table class="sjtablelayout">
	...
	<tr class="sjtable">
		<td id="td-sj1c" class="cat1 sjtable sjitem kill">Skeleton King</td>
		...
		<td id="td-sj4c" class="cat4 sjtable sjitem kill">Zoltun Kulle<br />(T2, level 70)</td>
		<td id="td-sj5c" class="cat5 sjtable sjitem kill">Rakanoth<br />(T7)</td>
		<td id="td-sj6c" class="cat6 sjtable sjitem kill">Butcher<br />(T10)</td>
		<td id="td-sj7c" class="cat7 sjtable sjitem kill">Belial<br />(T13)</td>
		<td id="td-sj8c" class="cat8 sjtable sjitem kill">Diablo (T13)<br />in under 90 sec.</td>
		<td id="td-sj9c" class="cat9 sjtable sjitem kill">Malthael (T13)<br />in under 45 sec.</td>
	</tr>
	<tr class="sjtable">
		<td id="td-sj1d" class="cat1 sjtable sjitem kill">Maghda</td>
		<td id="td-sj2d" class="cat2 sjtable sjitem kill">Izual<br />(Hard, level 60+)</td>
		<td id="td-sj3d" class="cat3 sjtable sjitem kill">Queen Araneae<br />(Master, level 70+)</td>
		<td id="td-sj4d" class="cat4 sjtable sjitem kill">Siegebreaker<br />(T4, level 70)</td>
		<td id="td-sj5d" class="cat5 sjtable sjitem kill">Adria<br />(T7)</td>
		<td id="td-sj6d" class="cat6 sjtable sjitem kill">Cydaea<br />(T10)</td>
...
var countDownDateNA = new Date("Sep 16, 2023 0:00:00 UTC").getTime();
var countDownDateEU = new Date("Sep 15, 2023 15:00:00 UTC").getTime();
var countDownDateAsia = new Date("Sep 15, 2023 8:00:00 UTC").getTime();
