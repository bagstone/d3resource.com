...
<head>
	<meta charset="utf-8"/>
	<title>Diablo 3: Season 21 Journey Tracker</title>
...
<h1>Diablo 3: Season 21 Journey Tracker</h1>
...
<p>List of conquests in Season 21:</p>
...
<table class="sjtablelayout">
	...
	<tr class="sjtable">
		...
		<td id="td-sj3c" class="cat3 sjtable sjitem kill">Queen Aranaea<br />(Master, level 70+)</td>
		<td id="td-sj4c" class="cat4 sjtable sjitem kill">Ghom<br />(T2, level 70)</td>
		<td id="td-sj5c" class="cat5 sjtable sjitem kill">Diablo<br />(T7)</td>
		<td id="td-sj6c" class="cat6 sjtable sjitem kill">Rakanoth<br />(T10)</td>
		<td id="td-sj7c" class="cat7 sjtable sjitem kill">Cydaea<br />(T13)</td>
		<td id="td-sj8c" class="cat8 sjtable sjitem kill">Skel. King (T13)<br />in under 30 sec.</td>
		<td id="td-sj9c" class="cat9 sjtable sjitem kill">Butcher(T13)<br />in under 15 sec.</td>
	</tr>
	<tr class="sjtable">
		<td id="td-sj1d" class="cat1 sjtable sjitem kill">Belial</td>
		<td id="td-sj2d" class="cat2 sjtable sjitem kill">Zoltan Kulle<br />(Hard, level 60+)</td>
...
var countDownDateNA = new Date("Jul 4, 2020 0:00:00 UTC").getTime();
var countDownDateEU = new Date("Jul 3, 2020 15:00:00 UTC").getTime();
var countDownDateAsia = new Date("Jul 3, 2020 8:00:00 UTC").getTime();
