...
<head>
	<meta charset="utf-8"/>
	<title>Diablo 3: Season 9 Journey Tracker</title>
...
<h1>Diablo 3: Season 9 Journey Tracker</h1>
...
<p>List of conquests in Season 9:</p>
<table class="conqtablelayout">
	<tr>
		...
		<td id="conq-d" class="conqitem">
			...
			<span class="conqdesc">50 million gold streak</span>
		</td>
		<td id="conq-e" class="conqitem">
			<span class="conqtitle">Speed Demon</span><br />
			<span class="conqdesc">TX Rift in under 2 mins</span>
		</td>
	</tr>
	<tr>
...
<table class="sjtablelayout">
	...
	<tr class="sjtable">
		<td id="td-sj1c" class="cat1 sjtable sjitem kill">Urzael</td>
		<td id="td-sj2c" class="cat2 sjtable sjitem kill">Maghda<br />(Hard, level 60+)</td>
		<td id="td-sj3c" class="cat3 sjtable sjitem kill">Araneae<br />(Master, level 70)</td>
		<td id="td-sj4c" class="cat4 sjtable sjitem kill">Ghom<br />(T2, level 70)</td>
		<td id="td-sj5c" class="cat5 sjtable sjitem kill">Izual (T7)</td>
		<td id="td-sj6c" class="cat6 sjtable sjitem kill">Rakanoth (T10)</td>
		<td id="td-sj7c" class="cat7 sjtable sjitem kill">Azmodan (T13)</td>
		<td id="td-sj8c" class="cat8 sjtable sjitem kill">Skel. King (T13)<br />in under 30 sec.</td>
		<td id="td-sj9c" class="cat9 sjtable sjitem kill">Butcher (T13) in<br />under 15 seconds</td>
	</tr>
	<tr class="sjtable">
		...
		<td id="td-sj4d" class="cat4 sjtable sjitem kill">Malthael<br />(T4, level 70)</td>
		<td id="td-sj5d" class="cat5 sjtable sjitem kill">Diablo (T7)</td>
		<td id="td-sj6d" class="cat6 sjtable sjitem kill">Adria (T10)</td>
		<td id="td-sj7d" class="cat7 sjtable sjitem kill">Cydaea (T13)</td>
	...
	<tr class="sjtable">
		...
		<td id="td-sj2m" class="cat2 sjtable rewards">1<sup>st</sup> Haedrig<br />(head+hands)</td>
		<td id="td-sj3m" class="cat3 sjtable rewards">2<sup>nd</sup> Haedrig<br />(feet+shoulders;<br />monk: neck+sh.)</td>
		<td id="td-sj4m" class="cat4 sjtable rewards">3<sup>rd</sup> Haedrig,<br />portrait frame,<br />"Rocky" (pet)</td>
...
<div id="bottomdiv">
	Haedrig's Gift contains the following class sets in Season 9:
	<br />
	Barbarian: <a href="http://us.battle.net/d3/en/item/spirit-of-the-earth" target="_blank">Might of the Earth</a> - 
	Crusader: <a href="http://us.battle.net/d3/en/item/crown-of-the-invoker" target="_blank">Thorns of the Invoker</a> - 
	Demon Hunter: <a href="http://us.battle.net/d3/en/item/the-shadows-bane" target="_blank">The Shadow's Mantle</a>
	<br />
	Monk: <a href="http://us.battle.net/d3/en/item/sunwukos-soul" target="_blank">Monkey King's Garb</a> - 
	Witch Doctor: <a href="http://us.battle.net/d3/en/item/jade-harvesters-peace" target="_blank">Raiment of the Jade Harvester</a> - 
	Wizard: <a href="http://us.battle.net/d3/en/item/firebirds-breast" target="_blank">Firebird's Finery</a>
	<br /><br /><br />
