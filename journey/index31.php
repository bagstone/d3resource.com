...
<head>
	<meta charset="utf-8"/>
	<title>Diablo 3: Season 31 Journey Tracker</title>
...
<h1>Diablo 3: Season 31 Journey Tracker</h1>
...
<p>List of conquests in Season 31:</p>
...
<table class="sjtablelayout">
	...
	<tr class="sjtable">
		...
		<td id="td-sj4c" class="cat4 sjtable sjitem kill">Araneae<br />(T2, level 70)</td>
		<td id="td-sj5c" class="cat5 sjtable sjitem kill">Butcher<br />(T7)</td>
		<td id="td-sj6c" class="cat6 sjtable sjitem kill">Malthael<br />(T10)</td>
		<td id="td-sj7c" class="cat7 sjtable sjitem kill">Adria<br />(T13)</td>
		<td id="td-sj8c" class="cat8 sjtable sjitem kill">Ghom<br />in under 30 sec.</td>
		<td id="td-sj9c" class="cat9 sjtable sjitem kill">Asmodan<br />in under 20 sec.</td>
	</tr>
	<tr class="sjtable">
		...
		<td id="td-sj4d" class="cat4 sjtable sjitem kill">Skeleton King<br />(T4, level 70)</td>
		<td id="td-sj5d" class="cat5 sjtable sjitem kill">Kulle<br />(T7)</td>
		<td id="td-sj6d" class="cat6 sjtable sjitem kill">Urzael<br />(T10)</td>
	...
	<tr class="sjtable">
		...
		<td id="td-sj9m" class="cat9 sjtable rewards">Goblin pet,<br />portrait frame</td>
	</tr>
	<tr class="sjtable">
...
<div id="bottomdiv">
	...
	<br /><br /><br />
	<a href="https://www.diablofans.com/forums/diablofans-forum/general-discussion-2/211245-season-journey-tracker" target="_blank">Link to Diablofans forum thread for more info, some tips, and feedback.</a>
</div>
...
var countDownDateNA = new Date("Apr 13, 2024 0:00:00 UTC").getTime();
var countDownDateEU = new Date("Apr 12, 2024 15:00:00 UTC").getTime();
var countDownDateAsia = new Date("Apr 12, 2024 8:00:00 UTC").getTime();
